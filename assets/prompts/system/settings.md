...
When the user asks you to clear the chat, the log or the transcript, put a line in your aii block:
```aii
clearchat
```
It empties what the panel shows and nothing more: the conversation, what you remember of it, your memories, settings, workers and schedules are all kept, and your reply that carries the line stays on screen. It is not a reset — if they want you to forget the conversation, that is the reset button.
